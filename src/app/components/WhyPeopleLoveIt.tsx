...
export default function WhyPeopleLoveIt() {
  return (
    <section className="bg-black text-white px-4 sm:px-8 md:px-16 py-20 text-center">
      {/* Title */}
      <h2 className="text-2xl sm:text-3xl font-bold mb-12">Why People Love It</h2>
    ...
    {FEATURES.map((item, index) => (
        <div
        key={index}
        className="relative w-full h-[200px] sm:h-[220px] rounded-xl text-white flex flex-col items-center justify-center text-sm px-4 text-center"
        style={{
      ...
      <div className="relative text-left text-white  max-w-6xl mx-auto rounded-xl overflow-hidden px-6 sm:px-12 py-10">
        <div className="absolute inset-0 bg-[#89C7D3] z-0" />
        <Image
          src="/todaybg.svg"
          alt="today-bg"
          fill
        ...
        <div className="max-w-2xl z-10 md:text-left text-center">
          <h3 className="text-xl sm:text-2xl font-bold mb-2">Today Only</h3>
          <h2 className="text-2xl sm:text-3xl font-bold mb-4">
            Get Your Aura Scan Report for ₹499
          </h2>
          <p className="text-sm mb-1">Regular Price ₹1,499 — 65% OFF</p>
          <p className="text-sm mb-6">Offer available for the next 100 people only.</p>
        </div>
